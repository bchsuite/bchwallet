...
func (s *Store) Balance(minConf, syncHeight int32) (bchutil.Amount, error) {
	var amt bchutil.Amount
	err := scopedView(s.namespace, func(ns walletdb.Bucket) error {
		var err error
...
func (s *Store) balance(ns walletdb.Bucket, minConf int32, syncHeight int32) (bchutil.Amount, error) {
