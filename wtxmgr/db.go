...
func fetchMinedBalance(ns walletdb.Bucket) (bchutil.Amount, error) {
...
func putMinedBalance(ns walletdb.Bucket, amt bchutil.Amount) error {
	v := make([]byte, 8)
...
// amount is returned.
func spendCredit(ns walletdb.Bucket, k []byte, spender *indexedIncidence) (bchutil.Amount, error) {
...
func unspendRawCredit(ns walletdb.Bucket, k []byte) (bchutil.Amount, error) {
...
func putDebit(ns walletdb.Bucket, txHash *chainhash.Hash, index uint32, amount bchutil.Amount, block *Block, credKey []byte) error {
