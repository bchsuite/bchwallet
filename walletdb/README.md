...
[![GoDoc](https://godoc.org/github.com/bchsuite/bchwallet/walletdb?status.png)]
(http://godoc.org/github.com/bchsuite/bchwallet/walletdb)
...
http://localhost:6060/pkg/github.com/bchsuite/bchwallet/walletdb

## Installation

```bash
$ go get github.com/bchsuite/bchwallet/walletdb
```

## Examples

* [Basic Usage Example]
  (http://godoc.org/github.com/bchsuite/bchwallet/walletdb#example-package--BasicUsage)  
