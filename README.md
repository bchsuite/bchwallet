...
```bash
$ cp $GOPATH/src/github.com/bchsuite/bchd/sample-btcd.conf ~/.btcd/btcd.conf
$ cp $GOPATH/src/github.com/bchsuite/bchwallet/sample-btcwallet.conf ~/.btcwallet/btcwallet.conf
